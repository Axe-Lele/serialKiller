...
public static class Localization
{
    ...
    public static List<string> m_Key;
	...
	static public string language
	{
		get
		{
			if (string.IsNullOrEmpty(mLanguage))
			{
				...
				mLanguage = PlayerPrefs.GetString("Language", "한국어");
    ...
    static public int GetKeyCount(string value)
    {
        if (m_Key == null)
        {
            m_Key = new List<string>();
        }
        ...
        foreach (KeyValuePair<string, string[]> pair in dictionary)
        {
            ...
            {
                Debug.Log("i : " + m_Key.Count + " / s : " + pair.Key);
                m_Key.Add(pair.Key);
            }
        }
        return m_Key.Count;
