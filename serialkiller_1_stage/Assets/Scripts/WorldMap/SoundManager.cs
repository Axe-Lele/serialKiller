...
public class SoundManager : Singleton<SoundManager>
{
	...
	public void PlaySFX(string name, bool loop = false, float pitch = 1, CallBack callback = null)//효과음 재생
	{
	...
	public float GetSFXLengthByName(string name)
	{
		for (int i = 0; i < SFXs.Length; i++)
		{
			if (SFXs[i].name == name)
				return SFXs[i].length;
		}
